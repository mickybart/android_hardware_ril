...
*/
    ...
    {RIL_REQUEST_SET_NETWORK_SELECTION_AUTOMATIC, dispatchSetNetworkSelectionAutomatic, responseVoid},
    {RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL, dispatchSetNetworkSelectionManual, responseVoid},
